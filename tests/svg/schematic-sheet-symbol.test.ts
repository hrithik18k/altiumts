...
test("renders a schematic sheet symbol with entries", async () => {
  const source = [
    ...
    "|RECORD=15|LOCATION.X=60|LOCATION.Y=150|XSIZE=180|YSIZE=100|COLOR=136|AREACOLOR=16777215|ISSOLID=F|UNIQUEID=POWER",
    ...
    "|RECORD=16|OWNERINDEX=1|DISTANCEFROMTOP=3|COLOR=136|AREACOLOR=16777215|TEXTCOLOR=136|TEXTFONTID=1|NAME=VIN|IOTYPE=1",
    "|RECORD=16|OWNERINDEX=1|SIDE=1|DISTANCEFROMTOP=5|COLOR=136|AREACOLOR=16777215|TEXTCOLOR=136|TEXTFONTID=1|NAME=VOUT|IOTYPE=2",
  ].join("\r\n")
